...
def request_twitter_api(resource_url, parameters=None, header=None, method='GET', return_header=False, credentials='/home/hxavier/ceweb/config/keys/twitter_violentometro.json'):
